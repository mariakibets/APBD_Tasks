...
public class AdvancedEmpDeptTests
{
    ...
    public void AllEmployeesShouldEarnMoreThan500()
    {
        ...
        bool allEarnMoreThan500 = emps.All(e => e.Sal > 500);

        Assert.True(allEarnMoreThan500);
    }
    ...
    public void ShouldFindAnyWithCommissionOver400()
    {
        ...
        bool anyWithHighCommission = emps.Any(e => e.Comm > 400);

        Assert.True(anyWithHighCommission);
    }
    ...
    public void ShouldReturnTotalIncomeIncludingCommission()
    {
        ...
        Assert.Contains(result, r => r.EName == "ALLEN" && r.Total == 1600);
    }
